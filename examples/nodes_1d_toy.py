...
if __name__ == "__main__":
  ...
  if test:
    ...
    tmp = onp.abs(dr2dp - dr2dp_numerical)
    print("max abs. diff", onp.max(tmp))
    print("mean abs. diff", onp.mean(tmp))
    print("median abs. diff", onp.median(tmp))
    print(tmp)
